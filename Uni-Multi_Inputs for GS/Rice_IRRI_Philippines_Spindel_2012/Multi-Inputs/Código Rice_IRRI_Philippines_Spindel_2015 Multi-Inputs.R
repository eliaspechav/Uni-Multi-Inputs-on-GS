...
for (t in 1:length(Traits_to_evaluate)){
  ...
  for(i in seq_along(folds )) {
    ...
    ETA1=list(Env=list(model="RKHS",K=K_E),Lines=list(model="RKHS",K=K_G), GE=list(model="RKHS",K=K_GE) )
    ...
    ETA2=list(Env=list(model="FIXED",X=ZE),Lines=list(model="FIXED",X=XL), K_GE=list(model="RKHS",K=K_GE))
    ...
    ETA3=list(Env=list(model="FIXED",X=ZE),Lines=list(model="RKHS",K=K_G), K_GE=list(model="RKHS",K=K_GE))
    ...
    ETA4=list(Env=list(model="RKHS",K=K_E),Lines=list(model="FIXED",X=XL), K_GE=list(model="RKHS",K=K_GE))
...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Rice_IRRI_Philippines_Spindel_2015_Improved.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Rice_IRRI_Philippines_Spindel_2015_Improved.csv"))
