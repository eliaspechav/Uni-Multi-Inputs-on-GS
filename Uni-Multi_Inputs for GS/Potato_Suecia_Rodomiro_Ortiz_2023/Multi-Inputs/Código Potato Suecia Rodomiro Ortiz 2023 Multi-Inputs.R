...
write_csv(Predictions_Final_traits, file.path(results_dir, "Predictions_Final_Potato_Suecia_Rodomiro_Ortiz_2023_Improved.csv"))
write_csv(Sumary_all_traits, file.path(results_dir, "Summary_all_traits_Potato_Suecia_Rodomiro_Ortiz_2023_Improved.csv"))
